...
//        }
        ...
        public string HexToInt(string subInput)
        {
        ...
        public string IntToHex(string subInput)
        {
            int asInt = 0;
            if (!int.TryParse(subInput, out asInt)) return "";
            return asInt.ToString("X");
        }
        ...
        public void DoCalc()
        {
            ...
            if (preParsedInput.Contains("IntToHex"))
            {
                resultStr = PreParseUsingCustomFunc(preParsedInput, "IntToHex", IntToHex);
            ...
            preParsedInput = PreParseUsingCustomFunc(preParsedInput, "HexToInt", HexToInt);
            //preParsedInput = PreParseUsingCustomFunc(preParsedInput, "IntToHex", IntToHex);

...
namespace MathParserTK
{
    ...
    public class MathParser
    {
        ...
        public const string Plus = OperatorMarker + "+";
        public const string UnPlus = OperatorMarker + "un+";
        public const string Minus = OperatorMarker + "-";
        public const string UnMinus = OperatorMarker + "un-";
        public const string Multiply = OperatorMarker + "*";
        public const string Divide = OperatorMarker + "/";
        public const string Degree = OperatorMarker + "^";
        public const string LeftParent = OperatorMarker + "(";
        public const string RightParent = OperatorMarker + ")";
        public const string Sqrt = FunctionMarker + "sqrt";
        public const string Sin = FunctionMarker + "sin";
        public const string Cos = FunctionMarker + "cos";
        public const string Tan = FunctionMarker + "tan";
        public const string ArcSin = FunctionMarker + "arcsin";
        public const string ArcCos = FunctionMarker + "arccos";
        public const string ArcTan = FunctionMarker + "arctan";
        public const string ArcCot = FunctionMarker + "arccot";
        public const string Cot = FunctionMarker + "cot";
        public const string Sh = FunctionMarker + "sh";
        public const string Ch = FunctionMarker + "ch";
        public const string Th = FunctionMarker + "th";
        public const string Log = FunctionMarker + "log";
        public const string Ln = FunctionMarker + "ln";
        public const string Exp = FunctionMarker + "exp";
        public const string Abs = FunctionMarker + "abs";
        ...
        /// </summary>
        public readonly Dictionary<string, string> supportedFunctions =
            new Dictionary<string, string>
            {
                { "sqrt", Sqrt },
                { "√", Sqrt },
        ...
        private readonly Dictionary<string, string> supportedConstants =
            new Dictionary<string, string>
            {
                ...
                {"π", NumberMaker +  Math.PI.ToString() },
            ...
            else if (NumberOfArguments(token) == 1)
            {
                ...
                switch (token)
                {
                    ...
                    case ArcSin:
                        ...
                        rst = ApplyInvTrigFunction(Math.Asin, arg);
                        break;
                    case Cos:
                        rst = ApplyTrigFunction(Math.Cos, arg);
                        break;
                    case ArcCos:
                        rst = ApplyInvTrigFunction(Math.Acos, arg);
                        break;
                    case Tan:
                        rst = ApplyTrigFunction(Math.Tan, arg);
                        break;
                    case ArcTan:
                        rst = ApplyInvTrigFunction(Math.Atan, arg);
                        break;
                    case Cot:
        ...
        /// <param name="arg">Argument</param>
        /// <returns>Result of function</returns>
        private double ApplyInvTrigFunction(Func<double, double> func, double arg)
        {
            arg = func(arg);

            if (!isRadians)
            {
                arg = (arg *180) / Math.PI; // Convert value to degree
            }

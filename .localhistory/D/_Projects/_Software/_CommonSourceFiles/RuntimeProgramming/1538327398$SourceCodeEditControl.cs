            ...
            for (int i = 0; i < sourceFilesRef.Count; i++)
            {
                if (sourceFilesRef[i].FileName.ToLower() == fileName)
                {
                    ...
                    if (fastColoredTextBox.Tag != null)
                    {
                        ...
                        //sf.editorScrollPosition = fastColoredTextBox.AutoScrollPosition;
                        sf.editorScrollVertical = fastColoredTextBox.VerticalScroll.Value;
                        sf.editorScrollHorizontal = fastColoredTextBox.HorizontalScroll.Value;
                        
                    }
                    
                    fastColoredTextBox.Text = sourceFilesRef[i].Contents;
                    fastColoredTextBox.Tag = sourceFilesRef[i];
                    //fastColoredTextBox.AutoScrollPosition = sourceFilesRef[i].editorScrollPosition;
                    fastColoredTextBox.HorizontalScroll.Value = sourceFilesRef[i].editorScrollHorizontal;
                    fastColoredTextBox.VerticalScroll.Value = sourceFilesRef[i].editorScrollVertical;
